...
export function Login({ nav }: { nav: (path: string) => void }) {
  ...
  const showToast = (msg: string) => {
    setToast(msg.includes(" ") ? `${msg} coming soon!` : `${msg} authentication coming soon!`);
    ...
    <div className="login-grid scan enter">
      ...
      <div className="login-left">
        ...
        <div style={{ position: "relative", textAlign: "left", padding: "0 72px", zIndex: 1, width: "100%", maxWidth: 540 }}>
          ...
          <div style={{ marginTop: 44 }}>
            <div className="chip chip-g" style={{ display: "inline-flex" }}><div className="dot" />ALL SYSTEMS OPERATIONAL</div>
          </div>
        </div>
      </div>
      {/* Right panel */}
      <div className="login-right" style={{ zIndex: 1, overflowY: "auto", justifyContent: "flex-start" }}>
        ...
        <div style={{ margin: "auto 0", width: "100%", maxWidth: 370, padding: "80px 0" }}>
          ...
          <div style={{ width: "100%" }}>
            <div className="h-md" style={{ marginBottom: 6, color: "var(--txt)" }}>Welcome back</div>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 24 }}>
            <span className="mono txt-c" style={{ fontSize: 11.5, cursor: "pointer" }} onClick={() => showToast("Password reset")}>Forgot password?</span>
          </div>

...
export function Shell({ children, cur, nav, title }: { children: React.ReactNode, cur: string, nav: (path: string) => void, title: string }) {
  ...
  return (
    <div style={{ background: "var(--void)", minHeight: "100vh" }}>
      ...
      <div style={{ position: "fixed", inset: 0, background: "radial-gradient(ellipse at 18% 52%,rgba(5,150,105,.04),transparent 58%),radial-gradient(ellipse at 82% 18%,rgba(16,185,129,.05),transparent 58%)", pointerEvents: "none", zIndex: 0 }} />
